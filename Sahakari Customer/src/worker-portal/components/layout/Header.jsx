  ...
  return (
    <header className="bg-surface-container-highest dark:bg-surface-container-highest w-full sticky top-0 border-b border-outline-variant dark:border-outline-variant z-40 px-4 md:px-6 h-14 md:h-16 flex items-center justify-between shadow-sm">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        <a
          href="/services"
          className="flex items-center gap-1.5 px-3 py-1.5 bg-secondary-container/40 hover:bg-secondary-container/70 border border-secondary/30 rounded-lg text-xs font-bold text-on-secondary-container transition-colors shadow-xs"
          title="Switch back to Customer Portal"
        >
